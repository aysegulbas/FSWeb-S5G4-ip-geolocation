...
function cardolustur(bilgi) {
  ...
  country.textContent = "".concat(bilgi.ülke, " (").concat(bilgi.ülkeKodu, ")");
  var koordinat = document.createElement("p");
  koordinat.textContent = "Enlem:".concat(bilgi.enlem, " Boylam:").concat(bilgi.boylam);
  var city = document.createElement("p");
  city.textContent = "\u015Eehir:".concat(bilgi.şehir);
  var saat = document.createElement("p");
  saat.textContent = "Saat dilimi:".concat(bilgi.saatdilimi);
  var para = document.createElement("p");
  para.textContent = "Para birimi:".concat(bilgi.parabirimi);
  var company = document.createElement("p");
  company.textContent = "ISP:".concat(bilgi.isp);
...
ipAdresimiAl().then(function () {
  _axios.default.get("https://apis.ergineer.com/ipgeoapi/" + benimIP).then(function (response) {
    cards.append(cardolustur(response.data));
  });
});
